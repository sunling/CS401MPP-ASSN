...
public enum TestData {
	...
	public void libraryMemberData() {
		...
		LibraryMember libraryMember = new LibraryMember("1001", "Andy", "Rogers", firstRecord, addresses.get(4));
		members.add(libraryMember);
		
		secondRecord = new CheckoutRecord();
		secondRecord.addEntry(allEntries.get(2));
		libraryMember = new LibraryMember("1002", "Drew", "Stevens", secondRecord, addresses.get(5));
		members.add(libraryMember);
		
		thirdRecord = new CheckoutRecord();
		thirdRecord.addEntry(allEntries.get(3));
		libraryMember = new LibraryMember("1003", "Sarah", "Eagleton", thirdRecord, addresses.get(6));
		members.add(libraryMember);
		
		libraryMember = new LibraryMember("1004", "Germane", "Vlastovok", new CheckoutRecord(), addresses.get(3));
		members.add(libraryMember);
