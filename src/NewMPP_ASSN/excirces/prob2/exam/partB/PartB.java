package NewMPP_ASSN.excirces.prob2.exam.partB;
...
public class PartB {
	...
	Function<CheckoutRecord, List<CheckoutRecordEntry>> functionalInterface = 
			(CheckoutRecord record)->record.getCheckoutEntries();
	
	
	//provide a method reference and the type of method reference
	//TYPE:  
	Function<CheckoutRecord, List<CheckoutRecordEntry>> methodReference = CheckoutRecord::getCheckoutEntries;
